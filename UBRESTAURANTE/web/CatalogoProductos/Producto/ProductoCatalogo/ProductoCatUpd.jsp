<%-- 
    Document   : ProductoCatUpd
    Created on : 04-13-2020, 01:54:26 PM
...
<html>
    ...
    <body>
        <div id="EncabezadoPagina" style="background-color: #4682B4;">
            <center>
                <h1 style="color: #FFFFFF; text-align: center;">Actualizando Producto</h1>                
            </center>
        </div>
        ...
        <form id="UpdProducto" role='form' action='<%=DirActual%>/ServletProducto' method='POST' enctype="multipart/form-data">
